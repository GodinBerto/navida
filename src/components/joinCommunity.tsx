    ...
    <section className="">
      <div className="flex flex-col md:flex-row w-full h-auto md:h-[700px]">
        ...
        <div className="flex items-center justify-end bg-blue-700 px-6 md:px-10 w-full md:w-1/2 py-10 md:py-0 relative overflow-hidden">
          <div className="absolute -top-[50%] rounded-full -left-[40%] w-[700px] h-[700px] bg-transparent border-[40px] border-blue-500/30"></div>
          <div className="absolute -bottom-[90%] rounded-full -left-[40%] w-[700px] h-[700px] bg-transparent border-[40px] border-blue-500/30"></div>
          <div className="absolute -bottom-[20%] rounded-full -right-[30%] w-[500px] h-[500px] bg-transparent border-[30px] border-blue-500/30"></div>
          <div className="text-end animate-fade-in flex flex-col gap-5 items-end text-white max-w-[600px] relative">
            ...
            <ul className="text-right space-y-2 mt-2">
              <li className="flex items-center justify-end gap-2">
                <span className="flex items-center gap-3">
                  <Handshake /> Access to exclusive networking events
                </span>
              </li>
              <li className="flex items-center justify-end gap-2">
                <span className="flex items-center gap-3">
                  <BookPlus /> Free learning materials and webinars
                </span>
              </li>
              <li className="flex items-center justify-end gap-2">
                <span className="flex items-center gap-3">
                  <MessageCircle /> Private mentorship and discussion groups
                </span>
              </li>
              <li className="flex items-center justify-end gap-2">
                <span className="flex items-center gap-3">
                  <Award /> Early access to job and training opportunities
                </span>
              </li>
            </ul>
            ...
            <Link
              href="/apply"
              className="mt-6 inline-block bg-white text-blue-700 font-semibold px-6 py-3 rounded-full hover:bg-gray-100 transition"
            >
              Apply Now
            </Link>
          </div>
